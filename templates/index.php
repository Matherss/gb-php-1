...
?>
    ...
    <?php if(!$_SESSION['login']) echo '<a href="./login_tmpl.php">Зайти</a>'?><?php if($_SESSION['login']) echo '<a href="../engine/logout.php">Выйти</a>'?><a href="./cart.php">Корзина</a><a href="./orders.php">Заказы</a></nav>
    </header>

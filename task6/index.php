<?php 
$title = "My Site";
$h1 = "Hello, this is my Site";


$menu = [
	'home'=>'#',
	'archive'=>'#',
	'contact'=>['phone'=>'tel:89996665544','vk'=>'https://vk.com/'],
];
$hashTag ="#";
?>
	...
	<div id="content">
		...
		<ul id="menu">
			<?php foreach ($menu as $key => $value) {
				...
				if(is_array($value)) {
					echo "<li><a href=" . $hashTag . ">" . $key . "</a></li><ol>";
					foreach ($value as $inner_key => $inner_value) {
						echo "<li class='innerli'><a href=" . (is_array($inner_value) ? '' : $inner_value ) . ">" . $inner_key . "</a></li>";
					}
				} else {
